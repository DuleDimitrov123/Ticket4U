...
namespace Reservations.Infrastructure.Migrations
{
    ...
    public partial class AddData : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            var ZdravkoColicConcert1ExternalId = new Guid("b29306df-c4aa-4573-87d5-f0186f192eef");

            var ZdravkoColicConcert2Id = new Guid("0f4c6f53-1cca-4d62-bcc8-a4797d2e0334");
            var ZdravkoColicConcert2ExternalId = new Guid("ecea3e94-e781-4ad0-8f5a-1933b6ad4df4");

            var ZdravkoColicConcert3Id = new Guid("86ccbb64-4245-4ff8-ae13-58371d26ffa7");
            var ZdravkoColicConcert3ExternalId = new Guid("6d2c4a3b-add0-4d25-95a9-8e5f954d0a10");

            var ZdravkoColicConcert4Id = new Guid("e1f48bf0-ff7c-4485-87cb-c1401fadd87f");
            var ZdravkoColicConcert4ExternalId = new Guid("b4996258-653c-4ccd-b2a0-08f1f569f998");

            var ZdravkoColicConcert5Id = new Guid("c3463d20-e728-4641-a149-a0df732e068c");
            var ZdravkoColicConcert5ExternalId = new Guid("7cf5099f-e474-4dc0-b970-23eb1aff21ab");

            var RafCamoraConcert1Id = new Guid("44977503-4f90-46d3-b306-9704c036d086");
            var RafCamoraConcert1ExternalId = new Guid("8fee6822-54b7-432f-9681-901266d42a65");

            var RafCamoraConcert2Id = new Guid("06b524eb-0fae-4dd0-b69a-75c3a778e53a");
            var RafCamoraConcert2ExternalId = new Guid("3603dc14-e7ac-42a6-a976-8f896eb03656");

            var RafCamoraConcert3Id = new Guid("e5dd71a0-8ef4-4b18-af7f-56d5644a3b45");
            var RafCamoraConcert3ExternalId = new Guid("e839cc12-b4bf-40e5-8a2a-f3edae545247");

            var RafCamoraConcert4Id = new Guid("b3d99114-e03d-4f78-95fd-f7e86f7fa49c");
            var RafCamoraConcert4ExternalId = new Guid("31a0d6b7-939e-4dae-a045-15983de06b37");

            var beogradskoDramskoPozoriste1Id = new Guid("7f64a219-a0b0-4500-ba3a-4b32f6d8b577");
            var beogradskoDramskoPozoriste1ExternalId = new Guid("95230bf1-d8a4-429b-b058-fe3e223285ab");

            var beogradskoDramskoPozoriste2Id = new Guid("3aea54d4-3e23-4198-908b-7dd564d3a1bd");
            var beogradskoDramskoPozoriste2ExternalId = new Guid("dd9afd4a-96f8-4769-bad2-d68ef6557eea");

            var beogradskoDramskoPozoriste3Id = new Guid("b6426a03-3347-4ff2-9980-7c404aa7ffb8");
            var beogradskoDramskoPozoriste3ExternalId = new Guid("8db9c1a8-b16f-4282-a3ff-c43e74fac6fb");
